...
/*
Steven is still building his tip calculator, using the same rules as before: T
ip 15% of the bill if the bill value is between 50 and 300, and if the value is different, the tip is 20%.
...
const myarray = [calcTip(tips[0])];[calcTip(tips[1])] ;[calcTip(tips[2])];

// Bonus Total 

 const total=[];
 total[0]= (tips[0]+18.75)
 total[1]= (tips[1]+ 111)
 total[2]= (tips[2]+ 8.8)

 console.log(`o valor total é ${total[0]}`)
 console.log(`o valor total é ${total[1]}`)
 console.log(`o valor total é ${total[2]}`)
